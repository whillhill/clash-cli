...
- 默认安装 `mihomo` 内核，[可选安装](https://github.com/whillhill/clash-cli/wiki/FAQ#%E5%AE%89%E8%A3%85-clash-%E5%86%85%E6%A0%B8) `clash`。
...
下述命令适用于 `x86_64` 架构，其他架构请戳：[一键安装-多架构](https://github.com/whillhill/clash-cli/wiki#%E4%B8%80%E9%94%AE%E5%AE%89%E8%A3%85-%E5%A4%9A%E6%9E%B6%E6%9E%84)

```bash
git clone --branch master --depth 1 https://gh-proxy.com/https://github.com/whillhill/clash-cli.git \
  && cd clash-cli \
  && sudo bash install.sh
```

> 如遇问题，请在查阅[常见问题](https://github.com/whillhill/clash-cli/wiki/FAQ)及 [issue](https://github.com/whillhill/clash-cli/issues?q=is%3Aissue) 未果后进行反馈。
...
```bash
$ clash-cli update https://example.com
👌 正在下载：原配置已备份...
🍃 下载成功：内核验证配置...
🍃 订阅更新成功

$ clash-cli update auto [url]
😼 已设置定时更新订阅
...
- `clash-cli update` 会记住上次更新成功的订阅链接，后续执行无需再指定。
...
[wiki](https://github.com/whillhill/clash-cli/wiki/FAQ)
